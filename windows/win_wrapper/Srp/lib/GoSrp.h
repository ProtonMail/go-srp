...
extern GoSlice GenerateProofs(GoInt32 p0, GoString p1, GoString p2, GoString p3, GoString p4, GoString p5, GoInt32 p6);

/// GenerateVerifier return back the raw bytes verifier.

extern GoSlice GenerateVerifier(GoString p0, GoString p1, GoSlice p2, GoInt32 p3);
